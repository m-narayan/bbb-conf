...
<html lang="en">
    ...
    <body>
        ...
        <div id="rightform">
            <br>
            <h3 style="text-align: center;">Add Server</h3>
            <form method="post" action="" name="frm" onsubmit="return server();">
                <table align="center" class="rightform">
                    ...
                    <tr><td>Big Blue Button URL</td><td><input type="text" name="url" size="40" maxlength="250"></td></tr>
            ...
            <tr><th>Server Name</th><th>Big Blue Button URL</th><th>Salt</th><th>Status</th><th>Edit</th><th>Delete</th></tr>
            <?php
