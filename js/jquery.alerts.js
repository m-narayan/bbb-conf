	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch (type) {
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="con_popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
					$("#con_popup_ok").click( function() {
						$.alerts._hide();
