            ...
            <?php
                while($row=mysql_fetch_array($result)){
                    ...
                    if($row['status']=="reject"){
                        echo "<td><a href='accept.php?meeting_id=".$row['id']."'>Accept</a></td>";
                        echo "<td></td>";
                    }else{
                        echo "<td><a href='reject.php?meeting_id=".$row['id']."'>Reject</a></td>";
                        echo "<td><a href='invite.php?id=".$row['id']."'>Broadcast</a></td>";
                    }
